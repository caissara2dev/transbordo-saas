...
export default async function OperationsPage() {
  ...
  return (
    <AppShell
      ...
      description="The operational core remains product-specific: governed event logging, overlap protection, shift windows, and revision history."
    >
        ...
        <Panel className="space-y-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-3xl border border-ink-900/10 bg-sand-50/70 p-4">
              <p className="text-xs uppercase tracking-[0.24em] text-ink-500">Fixed lines</p>
              <p className="mt-2 text-lg font-semibold text-ink-950">{pumps.join(" · ")}</p>
            </div>
            <div className="rounded-3xl border border-ink-900/10 bg-sand-50/70 p-4">
              <p className="text-xs uppercase tracking-[0.24em] text-ink-500">Shift model</p>
